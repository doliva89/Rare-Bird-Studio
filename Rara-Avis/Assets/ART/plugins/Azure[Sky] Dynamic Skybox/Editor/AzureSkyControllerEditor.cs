...
public class AzureSkyControllerEditor : Editor
{
	...
	private string[] ComputeMode   = new string[]{"Precomputed", "Real-Time"};
	private string[] SkyModel      = new string[]{"Standard", "Precomputed"};
	private string[] ElevationMode = new string[]{"Automatic", "Manual"};

    private string[] useReflectionProbe    = new string[] { "Off", "On" };
	...
	void OnEnable()
	{
        ...
        ReflectionProbeCullingMask = serializedObject.FindProperty("Azure_ReflectionProbeCullingMask");
	...
	public override void OnInspectorGUI()
	{
		...
		EditorGUILayout.Space ();
		GUILayout.Label ("Version 4.1.2", EditorStyles.miniLabel);
		bgRect = EditorGUILayout.GetControlRect ();
...
//			GUI.color = col1;
		...
		{
			EditorGUILayout.BeginHorizontal ();
			GUILayout.Label ("Sky Model", GUILayout.Width(labelWidth));
			Target.Azure_SkyModel = EditorGUILayout.Popup(Target.Azure_SkyModel, SkyModel);
			EditorGUILayout.EndHorizontal ();
			switch(Target.Azure_SkyModel)
			{
			case 0:
				EditorGUILayout.BeginHorizontal ();
				...
				case 0:
						if(Target.Azure_ComputeMode == 1)
						{
							//Rayleigh Color.
							EditorGUILayout.BeginHorizontal ();
							GUILayout.Label ("Lambda", GUILayout.Width(labelWidth));
			...
			case 1:
				//GUILayout.Label ("PRECOMPUTED TABLES:");
				//Inscatter 3D Table.
				GUI.color = col5;
				if(!Target.Azure_PrecomputedInscatterTexture3D)
					GUI.color = col6;
				EditorGUILayout.BeginHorizontal ();
				GUILayout.Label("Inscatter", GUILayout.Width(labelWidth));
				Target.Azure_PrecomputedInscatterTexture3D  =  (Texture3D)EditorGUILayout.ObjectField (Target.Azure_PrecomputedInscatterTexture3D, typeof(Texture3D), true);
				EditorGUILayout.EndHorizontal ();
				//Transmittance 2D Table.
				GUI.color = col5;
				if(!Target.Azure_PrecomputedTransmittanceTexture2D)
					GUI.color = col6;
				EditorGUILayout.BeginHorizontal ();
				GUILayout.Label("Transmittance", GUILayout.Width(labelWidth));
				Target.Azure_PrecomputedTransmittanceTexture2D  =  (Texture2D)EditorGUILayout.ObjectField (Target.Azure_PrecomputedTransmittanceTexture2D, typeof(Texture2D), true);
				EditorGUILayout.EndHorizontal ();
				GUI.color = col1;
				//Sun Glare 2D.
				GUI.color = col5;
				if(!Target.Azure_PrecomputedSunGlareTexture2D)
					GUI.color = col6;
				EditorGUILayout.BeginHorizontal ();
				GUILayout.Label("Sun Glare", GUILayout.Width(labelWidth));
				Target.Azure_PrecomputedSunGlareTexture2D  =  (Texture2D)EditorGUILayout.ObjectField (Target.Azure_PrecomputedSunGlareTexture2D, typeof(Texture2D), true);
				EditorGUILayout.EndHorizontal ();
				GUI.color = col1;
				//Sky Altitude.
				EditorGUILayout.BeginVertical ("Box");
				...
				EditorGUILayout.Space ();
				EditorGUILayout.Space ();
				GUILayout.Label ("Sky Altitude");
				EditorGUILayout.Space ();
				EditorGUILayout.EndHorizontal ();
				//Mode
				EditorGUILayout.BeginHorizontal ();
				GUILayout.Label ("Altitude Mode", GUILayout.Width(labelWidth));
				Target.Azure_PrecomputedElevationMode = EditorGUILayout.Popup(Target.Azure_PrecomputedElevationMode, ElevationMode);
				EditorGUILayout.EndHorizontal ();
				//Elevation Slider.
				if(Target.Azure_PrecomputedElevationMode == 1)
				{
					EditorGUILayout.BeginHorizontal ();
					GUILayout.Label("Altitude", GUILayout.Width(labelWidth));
					Target.Azure_PrecomputedSkyElevation = EditorGUILayout.Slider(Target.Azure_PrecomputedSkyElevation, 0.0f, 1.0f);
					EditorGUILayout.EndHorizontal ();
				}
				//Min Max.
				EditorGUILayout.BeginHorizontal ();
				GUILayout.Label("Min Altitude");
				Target.Azure_PrecomputedMinElevation = EditorGUILayout.FloatField(Target.Azure_PrecomputedMinElevation, GUILayout.Width(50));
				EditorGUILayout.EndHorizontal ();
				//EditorGUILayout.Space ();
				EditorGUILayout.BeginHorizontal ();
				GUILayout.Label("Max Altitude");
				Target.Azure_PrecomputedMaxElevation = EditorGUILayout.FloatField(Target.Azure_PrecomputedMaxElevation, GUILayout.Width(50));
				EditorGUILayout.EndHorizontal ();
				EditorGUILayout.EndVertical();
				//Layers.
				EditorGUILayout.BeginVertical ("Box");
				...
				Target.Azure_PrecomputedMinLayer = EditorGUILayout.FloatField(Target.Azure_PrecomputedMinLayer, GUILayout.Width(50));
				EditorGUILayout.Space ();
				GUILayout.Label("Max", GUILayout.Width(30));
				Target.Azure_PrecomputedMaxLayer = EditorGUILayout.FloatField(Target.Azure_PrecomputedMaxLayer, GUILayout.Width(50));
				EditorGUILayout.EndHorizontal ();
				EditorGUILayout.MinMaxSlider(ref Target.Azure_PrecomputedMinLayer, ref Target.Azure_PrecomputedMaxLayer, 0.0f, 1.0f);
				EditorGUILayout.EndVertical();
				//Rg/Rt.
				EditorGUILayout.BeginHorizontal ();
				GUILayout.Label ("Rg", GUILayout.Width(20));
				Target.Azure_PrecomputedRg = EditorGUILayout.FloatField(Target.Azure_PrecomputedRg);
				GUILayout.Label ("Rt", GUILayout.Width(20));
				Target.Azure_PrecomputedRt = EditorGUILayout.FloatField(Target.Azure_PrecomputedRt);
				EditorGUILayout.EndHorizontal ();
				//Sun Intensity.
				EditorGUILayout.BeginHorizontal ();
				GUILayout.Label("Sun Intensity", GUILayout.Width(labelWidth));
				Target.Azure_PrecomputedSunIntensity = EditorGUILayout.Slider(Target.Azure_PrecomputedSunIntensity, 0.0f, 200.0f);
				EditorGUILayout.EndHorizontal ();
				//Moon Intensity.
				EditorGUILayout.BeginHorizontal ();
				GUILayout.Label("Moon Intensity", GUILayout.Width(labelWidth));
				Target.Azure_PrecomputedMoonIntensity = EditorGUILayout.Slider(Target.Azure_PrecomputedMoonIntensity, 0.0f, 25.0f);
				EditorGUILayout.EndHorizontal ();
				//Deep Night Intensity.
				EditorGUILayout.BeginHorizontal ();
				GUILayout.Label("Deep Darkness", GUILayout.Width(labelWidth));
				Target.Azure_PrecomputedDeepDarkness = EditorGUILayout.Slider(Target.Azure_PrecomputedDeepDarkness, 0.0f, 1.0f);
				EditorGUILayout.EndHorizontal ();
				//Night Color.
				EditorGUILayout.BeginHorizontal ();
				GUILayout.Label("Night Scatter Color", GUILayout.Width(labelWidth));
				Target.Azure_PrecomputedNightColor = EditorGUILayout.ColorField(Target.Azure_PrecomputedNightColor);
				EditorGUILayout.EndHorizontal ();
				//Sun Intensity.
				EditorGUILayout.BeginHorizontal ();
				GUILayout.Label("Exposure", GUILayout.Width(labelWidth));
				Target.Azure_PrecomputedExposure = EditorGUILayout.Slider(Target.Azure_PrecomputedExposure, 0.0f, 2.0f);
				EditorGUILayout.EndHorizontal ();
		...
		if(Target.Azure_ShowNightSkyTab)
		{
			...
			case 0:
					...
					EditorGUILayout.EndHorizontal ();
				if(Target.Azure_SkyModel == 1)
				{
					//Space Intensity.
					EditorGUILayout.BeginHorizontal ();
					GUILayout.Label ("(High Alt.)", GUILayout.Width(labelWidth));
					Target.Azure_StarfieldSpaceIntensity = EditorGUILayout.Slider (Target.Azure_StarfieldSpaceIntensity, 0.0f, 10.0f);
					EditorGUILayout.EndHorizontal ();
				}
					//Stars Scintillation.
					EditorGUILayout.BeginHorizontal ();
				...
				if(Target.Azure_SkyModel == 1)
				{
					EditorGUILayout.BeginHorizontal ();
					GUILayout.Label ("(High Alt.)", GUILayout.Width(labelWidth));
					Target.Azure_MilkyWaySpaceIntensity = EditorGUILayout.Slider (Target.Azure_MilkyWaySpaceIntensity, 0.0f, 1.0f);
					EditorGUILayout.EndHorizontal ();
				}
		...
		if(Target.Azure_ShowCloudTab)
		{
			...
			case 1://Precomputed Sky Model.
				GUILayout.Label ("Working in progress...​");
				GUILayout.Label ("Working in progress...​");
				GUILayout.Label ("Working in progress...​");
				break;
			}
		...
		if(Target.Azure_ShowFogTab)
		{
			...
			case 1:
				...
				case 0://Timeline
					...
					EditorGUILayout.BeginHorizontal ();
					GUILayout.Label ("Mie Depth", GUILayout.Width(labelWidth));
					Target.Azure_PrecomputedMieDepth = EditorGUILayout.Slider (Target.Azure_PrecomputedMieDepth, 1.0f, 20.0f);
					EditorGUILayout.EndHorizontal ();
					//Low Altitude.
					EditorGUILayout.BeginHorizontal ();
					GUILayout.Label ("Density", GUILayout.Width(labelWidth-23));
					if (GUILayout.Button ("R", GUILayout.Width(18), GUILayout.Height(15))) { Target.Azure_PrecomputedFogDensity1Curve[Day] = AnimationCurve.Linear(0.0f,10.0f,24.0f,10.0f); }
					Target.Azure_PrecomputedFogDensity1Curve[Day] = EditorGUILayout.CurveField (Target.Azure_PrecomputedFogDensity1Curve[Day], curveColor, new Rect(0.0f,0.0f,24.0f,150.0f));
					GUILayout.TextField (Target.Azure_PrecomputedFogDensity1.ToString(), GUILayout.Width (curveValueWidth));
					EditorGUILayout.EndHorizontal ();
					//High Altitude.
					EditorGUILayout.BeginHorizontal ();
					GUILayout.Label ("(High Alt.)", GUILayout.Width(labelWidth-23));
					if (GUILayout.Button ("R", GUILayout.Width(18), GUILayout.Height(15))) { Target.Azure_PrecomputedFogDensity2Curve[Day] = AnimationCurve.Linear(0.0f,3.0f,24.0f,3.0f); }
					Target.Azure_PrecomputedFogDensity2Curve[Day] = EditorGUILayout.CurveField (Target.Azure_PrecomputedFogDensity2Curve[Day], curveColor, new Rect(0.0f,0.0f,24.0f,25f));
					GUILayout.TextField (Target.Azure_PrecomputedFogDensity2.ToString(), GUILayout.Width (curveValueWidth));
					EditorGUILayout.EndHorizontal ();
                    //Fix Black Screen.
                    EditorGUILayout.BeginHorizontal();
                    GUILayout.Label("Fix Black Screen", GUILayout.Width(labelWidth));
                    Target.Azure_PrecomputedFixScreenBlackColor = EditorGUILayout.Slider(Target.Azure_PrecomputedFixScreenBlackColor, 0.0f, 100.0f);
                    EditorGUILayout.EndHorizontal();
                    break;
				...
				case 1://Elevation
					...
					EditorGUILayout.BeginHorizontal ();
					GUILayout.Label ("Density", GUILayout.Width(labelWidth-23));
					if (GUILayout.Button ("R", GUILayout.Width(18), GUILayout.Height(15))) { Target.Azure_PrecomputedFogDensity1CurveE[Day] = AnimationCurve.Linear(-1.0f,10.0f,1.0f,10.0f); }
					Target.Azure_PrecomputedFogDensity1CurveE[Day] = EditorGUILayout.CurveField (Target.Azure_PrecomputedFogDensity1CurveE[Day], curveColor, new Rect(-1.0f,0.0f,2.0f,150.0f));
					GUILayout.TextField (Target.Azure_PrecomputedFogDensity1.ToString(), GUILayout.Width (curveValueWidth));
					EditorGUILayout.EndHorizontal ();
					//High Altitude.
					EditorGUILayout.BeginHorizontal ();
					GUILayout.Label ("(High Alt.)", GUILayout.Width(labelWidth-23));
					if (GUILayout.Button ("R", GUILayout.Width(18), GUILayout.Height(15))) { Target.Azure_PrecomputedFogDensity2CurveE[Day] = AnimationCurve.Linear(-1.0f,3.0f,1.0f,3.0f); }
					Target.Azure_PrecomputedFogDensity2CurveE[Day] = EditorGUILayout.CurveField (Target.Azure_PrecomputedFogDensity2CurveE[Day], curveColor, new Rect(-1.0f,0.0f,2.0f,25f));
					GUILayout.TextField (Target.Azure_PrecomputedFogDensity2.ToString(), GUILayout.Width (curveValueWidth));
					EditorGUILayout.EndHorizontal ();
                    //Fix Black Screen.
                    EditorGUILayout.BeginHorizontal();
		...
		if(Target.Azure_ShowLightingTab)
		{
			...
			case 0:
				...
				case 2:
                    ...
                    //Reflection Probe GameObject.
                    GUI.color = col5;
                    if (!Target.Azure_ReflectionProbe)
                    {
                        GUI.color = col6;
                        //Debug.LogError ("The sun directional light is missing! Please attach a directional light to 'Sun Dir Light' propertie in OBJECTS & MATERIALS tab.");
                    }
                    EditorGUILayout.BeginHorizontal();
                    GUILayout.Label("Reflection Probe", GUILayout.Width(labelWidth));
                    Target.Azure_ReflectionProbe = (ReflectionProbe)EditorGUILayout.ObjectField(Target.Azure_ReflectionProbe, typeof(ReflectionProbe), true);
                    EditorGUILayout.EndHorizontal();
                    GUI.color = col1;
                    //Reflection Mode.
                    EditorGUILayout.BeginHorizontal();
                    GUILayout.Label("Reflection Mode:", GUILayout.Width(labelWidth));
                    Target.Azure_UseReflectionProbe = EditorGUILayout.Popup(Target.Azure_UseReflectionProbe, useReflectionProbe);
                    EditorGUILayout.EndHorizontal();
                    if(Target.Azure_UseReflectionProbe == 1)
                    {
                        Target.Azure_ReflectionProbe.gameObject.SetActive(true);
                        //Culling Mask
                        EditorGUILayout.BeginHorizontal();
                        GUILayout.Label("Culling Mask", GUILayout.Width(labelWidth));
                        EditorGUILayout.PropertyField(ReflectionProbeCullingMask, GUIContent.none);
                        EditorGUILayout.EndHorizontal();
                        //Time Slicing
                        EditorGUILayout.BeginHorizontal();
                        GUILayout.Label("Time Slicing", GUILayout.Width(labelWidth));
                        Target.Azure_ReflectionProbeTimeSlicing = EditorGUILayout.Popup(Target.Azure_ReflectionProbeTimeSlicing, reflectionTimeSlicing);
                        EditorGUILayout.EndHorizontal();
                        switch (Target.Azure_ReflectionProbeTimeSlicing)
                        {
                            case 0:
                                Target.Azure_ReflectionProbe.timeSlicingMode = UnityEngine.Rendering.ReflectionProbeTimeSlicingMode.AllFacesAtOnce;
                                break;
                            case 1:
                                Target.Azure_ReflectionProbe.timeSlicingMode = UnityEngine.Rendering.ReflectionProbeTimeSlicingMode.IndividualFaces;
                                break;
                            case 2:
                                Target.Azure_ReflectionProbe.timeSlicingMode = UnityEngine.Rendering.ReflectionProbeTimeSlicingMode.NoTimeSlicing;
                                break;
                        }
                        //Refresh Mode
                        EditorGUILayout.BeginHorizontal();
                        GUILayout.Label("Refresh Mode", GUILayout.Width(labelWidth));
                        Target.Azure_ReflectionProbeRefreshMode = EditorGUILayout.Popup(Target.Azure_ReflectionProbeRefreshMode, reflectionRefreshMode);
                        EditorGUILayout.EndHorizontal();
                        switch (Target.Azure_ReflectionProbeRefreshMode)
                        {
                            case 0:
                                Target.Azure_ReflectionProbe.refreshMode = UnityEngine.Rendering.ReflectionProbeRefreshMode.OnAwake;
                                break;
                            case 1:
                                Target.Azure_ReflectionProbe.refreshMode = UnityEngine.Rendering.ReflectionProbeRefreshMode.EveryFrame;
                                break;
                            case 2:
                                Target.Azure_ReflectionProbe.refreshMode = UnityEngine.Rendering.ReflectionProbeRefreshMode.ViaScripting;
                                //Refresh Mode
                                EditorGUILayout.BeginHorizontal();
                                GUILayout.Label("Time to Refresh", GUILayout.Width(labelWidth));
                                Target.Azure_ReflectionProbeTimeToUpdate = EditorGUILayout.FloatField(Target.Azure_ReflectionProbeTimeToUpdate);
                                EditorGUILayout.EndHorizontal();
                                //Force Update at First Frame?
                                EditorGUILayout.BeginHorizontal();
                                GUILayout.Label("Update at Start?");
                                Target.Azure_ReflectionProbeUpdateAtFirstFrame = EditorGUILayout.Toggle(Target.Azure_ReflectionProbeUpdateAtFirstFrame, GUILayout.Width(15));
                                EditorGUILayout.EndHorizontal();
                                EditorGUILayout.Space();
                                break;
                        }
                        ...
                        EditorGUILayout.BeginHorizontal();
                        GUILayout.Label("Intensity", GUILayout.Width(labelWidth - 23));
                        if (GUILayout.Button("R", GUILayout.Width(18), GUILayout.Height(15))) { Target.Azure_ReflectionProbeIntensityCurve[Day] = AnimationCurve.Linear(0.0f, 1.0f, 24.0f, 1.0f); }
                        Target.Azure_ReflectionProbeIntensityCurve[Day] = EditorGUILayout.CurveField(Target.Azure_ReflectionProbeIntensityCurve[Day], curveColor, new Rect(0.0f, 0.0f, 24.0f, 8.0f));
                        GUILayout.TextField(Target.Azure_ReflectionProbeIntensity.ToString(), GUILayout.Width(curveValueWidth));
                        EditorGUILayout.EndHorizontal();
                    }
                    else { Target.Azure_ReflectionProbe.gameObject.SetActive(false); }
			...
			case 1:
				...
				case 2:
                    ...
                    if (Target.Azure_UseReflectionProbe == 1)
                    {
                        ...
                        EditorGUILayout.BeginHorizontal();
                        GUILayout.Label("Intensity", GUILayout.Width(labelWidth - 23));
                        if (GUILayout.Button("R", GUILayout.Width(18), GUILayout.Height(15))) { Target.Azure_ReflectionProbeIntensityCurveE[Day] = AnimationCurve.Linear(-1.0f, 1.0f, 1.0f, 1.0f); }
                        Target.Azure_ReflectionProbeIntensityCurveE[Day] = EditorGUILayout.CurveField(Target.Azure_ReflectionProbeIntensityCurveE[Day], curveColor, new Rect(-1.0f, 0.0f, 2.0f, 8.0f));
                        GUILayout.TextField(Target.Azure_ReflectionProbeIntensity.ToString(), GUILayout.Width(curveValueWidth));
                        EditorGUILayout.EndHorizontal();
                    }
                    else { Target.Azure_ReflectionProbe.gameObject.SetActive(false); }
		...
		if(Target.Azure_ShowOptionsTab)
		{
			...
			EditorGUILayout.EndHorizontal ();
			//Precomputed Sky Ground.
			if(Target.Azure_SkyModel == 1)
			{
				EditorGUILayout.BeginHorizontal ();
				GUILayout.Label ("Sky Ground");
				Target.Azure_PrecomputedSkyGround = EditorGUILayout.Toggle (Target.Azure_PrecomputedSkyGround, GUILayout.Width(15));
				EditorGUILayout.EndHorizontal ();
			}
			//Gamma.
			EditorGUILayout.BeginHorizontal ();
